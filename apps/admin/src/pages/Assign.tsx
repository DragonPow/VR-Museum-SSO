...
const styles: Record<string, React.CSSProperties> = {
  ...
  slotGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '14px', alignContent: 'start' },
  ...
  picker: { background: '#0f0a06', border: '1px solid #3a2e1e', borderRadius: '14px', width: '820px', maxWidth: '96vw', maxHeight: '88vh', display: 'flex', flexDirection: 'column' },
  ...
  pickerGrid: { flex: 1, overflowY: 'auto', padding: '16px 24px', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: '12px', alignContent: 'start' },
