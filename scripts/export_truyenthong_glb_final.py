...
OUTPUT = Path(r"C:\Users\Admin\AppData\Local\Temp\vm_out\truyenthong.raw.glb")
...
def main() -> None:
    ...
    print(f"VM_EXPORT raw_output={OUTPUT}")
    print(f"VM_EXPORT raw_output_bytes={OUTPUT.stat().st_size}")
